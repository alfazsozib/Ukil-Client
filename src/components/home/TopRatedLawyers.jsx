    ...
    return (
        <div className="mt-28">
            ...
            <div className="container mx-auto grid grid-cols-3 gap-6">
                <div className="px-8 py-6 space-y-4 transition-colors duration-300 transform border cursor-pointer rounded-xl group border-gray-700">
                    <div className="flex flex-col sm:-mx-4 sm:flex-row">
                        ...
                        <div className="mt-4 sm:mx-4 sm:mt-0">
                            ...
                            <div className="flex items-center gap-2 my-1">
                                <FaStar className="text-1xl text-yellow-400" />
                                <FaStar className="text-1xl text-yellow-400" />
                                <FaStar className="text-1xl text-yellow-400" />
                                <FaStar className="text-1xl text-yellow-400" />
                            </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-4">
                            <PiBagFill className="text-blue-500 text-xl" />
